...
class Board:
	...
	def GetBoardState(self):
		boardState = []
		for col in self.boardState:
			for value in col:
				if value == "X" or value == "O":
					boardState.append(value)
				else:
					boardState.append(" ")

		return {"gameTitle": "Naughts and crosses", "boardState": [boardState[0], boardState[3], boardState[6], boardState[1], boardState[4], boardState[7], boardState[2], boardState[5], boardState[8]]}
